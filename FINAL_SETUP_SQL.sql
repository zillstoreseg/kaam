/*
  ════════════════════════════════════════════════════════════════════════
  🚀 FINAL PLATFORM OWNER SETUP - RUN THIS IN SUPABASE SQL EDITOR
  ════════════════════════════════════════════════════════════════════════

  INSTRUCTIONS:
  1. Copy this ENTIRE file
  2. Go to: https://viwgdxffvehogkflhkjw.supabase.co
...
-- ============================================================================
-- 6. CREATE ACADEMY_FEATURE_OVERRIDES TABLE
-- ============================================================================
...
-- ============================================================================
-- 11. SEED PLAN FEATURES - BASIC PLAN
-- ============================================================================
...
-- ============================================================================
-- 12. SEED PLAN FEATURES - PRO PLAN
-- ============================================================================
...
-- ============================================================================
-- 13. SEED PLAN FEATURES - ELITE PLAN
-- ============================================================================
...
-- ============================================================================
-- 14. ASSIGN OWNER ROLE TO YOUR ACCOUNT
-- ============================================================================

INSERT INTO platform_roles (user_id, role)
VALUES ('a0ffa70f-01f6-43ab-be81-df9cd2ee438d', 'owner')
...
BEGIN
  ...
  RAISE NOTICE '   1. Log out of your current session';
  RAISE NOTICE '   2. Login with credentials above';
  RAISE NOTICE '   3. Look for "Platform Admin" button in sidebar (crown icon)';
  RAISE NOTICE '   4. Click it to access /platform-admin';
  RAISE NOTICE '';
  RAISE NOTICE '✨ You should now see:';
  RAISE NOTICE '   • Overview tab (academy statistics)';
  RAISE NOTICE '   • Academies tab (create/manage tenants)';
  RAISE NOTICE '   • Plans tab (Basic, Pro, Elite)';
  RAISE NOTICE '   • Features tab (21 features)';
  RAISE NOTICE '';
  RAISE NOTICE '════════════════════════════════════════════════════════════════';
  RAISE NOTICE '';
END $$;
...
-- Show current status
SELECT
  (SELECT COUNT(*) FROM platform_roles) as owners,
