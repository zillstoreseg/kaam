...
type Language = 'en' | 'ar' | 'hi' | 'ml' | 'ur' | 'fil';
...
const translations: Record<Language, Record<string, string>> = {
  ...
  ml: {
    ...
    'auth.resetPassword': 'പാസ്‌വേഡ് റീസെറ്റ്',
    ...
    'dashboard.totalBranches': 'ആകെ ശാഖകൾ',
    'dashboard.todayAttendance': 'ഇന്നത്തെ ഹാജർ',
    'dashboard.activePackages': 'സജീവ പാക്കേജുകൾ',
    'dashboard.expiringPackages': 'ഉടൻ കാലഹരണപ്പെടുന്നവ',
    'students.title': 'വിദ്യാർത്ഥികൾ',
    'students.add': 'വിദ്യാർത്ഥി ചേർക്കുക',
    'students.search': 'വിദ്യാർത്ഥികളെ തിരയുക...',
    'students.name': 'പേര്',
    'students.phone': 'ഫോൺ',
    'students.nationality': 'ദേശീയത',
    'students.address': 'വിലാസം',
    'students.package': 'പാക്കേജ്',
    'students.branch': 'ശാഖ',
    'students.status': 'സ്റ്റാറ്റസ്',
    'students.active': 'സജീവം',
    'students.inactive': 'നിഷ്‌ക്രിയം',
    'students.actions': 'പ്രവർത്തനങ്ങൾ',
    'students.edit': 'എഡിറ്റ്',
    'students.delete': 'ഇല്ലാതാക്കുക',
    'students.packageStart': 'പാക്കേജ് ആരംഭം',
    'students.packageEnd': 'പാക്കേജ് അവസാനം',
    'students.notes': 'കുറിപ്പുകൾ',
    'attendance.title': 'ഹാജർ',
    'attendance.mark': 'ഹാജർ രേഖപ്പെടുത്തുക',
    'attendance.date': 'തീയതി',
    'attendance.student': 'വിദ്യാർത്ഥി',
    'attendance.status': 'സ്റ്റാറ്റസ്',
    'attendance.present': 'ഹാജരായി',
    'attendance.absent': 'ഹാജരല്ല',
    'attendance.late': 'വൈകി',
    'attendance.note': 'കുറിപ്പ്',
    'attendance.markedBy': 'രേഖപ്പെടുത്തിയത്',
    'attendance.history': 'ഹാജർ ചരിത്രം',
    'packages.title': 'പാക്കേജുകൾ',
    'packages.add': 'പാക്കേജ് ചേർക്കുക',
    'packages.name': 'പാക്കേജ് പേര്',
    'packages.sessionsPerMonth': 'സെഷനുകൾ/മാസം',
    'packages.sessionsPerWeek': 'സെഷനുകൾ/ആഴ്ച',
    'packages.price': 'വില',
    'packages.description': 'വിവരണം',
    'branches.title': 'ശാഖകൾ',
    'branches.add': 'ശാഖ ചേർക്കുക',
    'branches.name': 'ശാഖയുടെ പേര്',
    'branches.location': 'സ്ഥാനം',
    'reports.title': 'റിപ്പോർട്ടുകൾ',
    'reports.export': 'എക്‌സ്‌പോർട്ട്',
    'reports.filter': 'ഫിൽട്ടർ',
    'reports.dateRange': 'തീയതി പരിധി',
    'reports.from': 'മുതൽ',
    'reports.to': 'വരെ',
    'settings.title': 'ക്രമീകരണങ്ങൾ',
    'settings.academyName': 'അക്കാദമിയുടെ പേര്',
    'settings.logo': 'ലോഗോ',
    'settings.language': 'ഭാഷ',
    'settings.notifications': 'അറിയിപ്പുകൾ',
    'settings.theme': 'തീം',
    'settings.save': 'സേവ്',
    'settings.taxNumber': 'നികുതി രജിസ്ട്രേഷൻ നമ്പർ',
    'role.super_admin': 'സൂപ്പർ അഡ്മിൻ',
    'role.branch_manager': 'ശാഖാ മാനേജർ',
    'role.coach': 'കോച്ച്',
    'role.stock_manager': 'സ്റ്റോക്ക് മാനേജർ',
    'role.accountant': 'അക്കൗണ്ടന്റ്',
    'invoices.title': 'ഇൻവോയ്‌സുകൾ',
    'invoices.invoice': 'ഇൻവോയ്സ്',
    'invoices.invoiceNumber': 'ഇൻവോയ്സ് നമ്പർ',
    'invoices.invoiceDetails': 'ഇൻവോയ്സ് വിശദാംശങ്ങൾ',
    'invoices.date': 'തീയതി',
    'invoices.customer': 'ഉപഭോക്താവ്',
    'invoices.branch': 'ശാഖ',
    'invoices.total': 'ആകെ',
    'invoices.paymentMethod': 'പേയ്മെന്റ് രീതി',
    'invoices.paymentStatus': 'പേയ്മെന്റ് സ്റ്റാറ്റസ്',
    'invoices.status': 'സ്റ്റാറ്റസ്',
    'invoices.search': 'ഇൻവോയ്‌സുകൾ തിരയുക...',
    'invoices.allBranches': 'എല്ലാ ശാഖകളും',
    'invoices.allPaymentMethods': 'എല്ലാ പേയ്‌മെന്റ് രീതികളും',
    'invoices.allStatuses': 'എല്ലാ സ്റ്റാറ്റസുകളും',
    'invoices.dateFrom': 'തീയതി മുതൽ',
    'invoices.dateTo': 'തീയതി വരെ',
    'invoices.totalRevenue': 'ആകെ വരുമാനം',
    'invoices.totalPaid': 'ആകെ അടച്ചത്',
    'invoices.totalPending': 'ആകെ ബാക്കി',
    'invoices.noInvoices': 'ഇൻവോയ്‌സുകളൊന്നും കണ്ടെത്തിയില്ല',
    'invoices.billTo': 'ബില്ല് ചെയ്യേണ്ടത്',
    'invoices.item': 'ഇനം',
    'invoices.quantity': 'അളവ്',
    'invoices.unitPrice': 'യൂണിറ്റ് വില',
    'invoices.subtotal': 'ഉപ-ആകെ',
    'invoices.vat': 'വാറ്റ്',
    'invoices.amountPaid': 'അടച്ച തുക',
    'invoices.thankYou': 'നിങ്ങളുടെ ബിസിനസ്സിന് നന്ദി!',
    'sales.cash': 'പണം',
    'sales.card': 'കാർഡ്',
    'sales.installment': 'ഗഡു',
    'sales.paid': 'അടച്ചു',
    'sales.pending': 'ബാക്കി',
    'sales.partial': 'ഭാഗികം',
    'stockInventory.title': 'സ്റ്റോക്ക് ഇൻവെന്ററി മാനേജ്മെന്റ്',
    'stockInventory.subtitle': 'സ്റ്റോക്ക് എണ്ണവും വിൽപ്പന റിപ്പോർട്ടുകളും ട്രാക്ക് ചെയ്യുക',
    'stockInventory.stockCount': 'സ്റ്റോക്ക് എണ്ണം',
    'stockInventory.salesReport': 'വിൽപ്പന റിപ്പോർട്ട്',
    'stockInventory.item': 'ഇനം',
    'stockInventory.allItems': 'എല്ലാ ഇനങ്ങളും',
    'stockInventory.startDate': 'ആരംഭ തീയതി',
    'stockInventory.endDate': 'അവസാന തീയതി',
    'stockInventory.loadReport': 'റിപ്പോർട്ട് ലോഡ് ചെയ്യുക',
    'stockInventory.newStockCount': 'പുതിയ സ്റ്റോക്ക് എണ്ണം',
    'stockInventory.exportCSV': 'CSV-ലേക്ക് എക്‌സ്‌പോർട്ട് ചെയ്യുക',
    'stockInventory.date': 'തീയതി',
    'stockInventory.systemQty': 'സിസ്റ്റം അളവ്',
    'stockInventory.actualQty': 'യഥാർത്ഥ അളവ്',
    'stockInventory.difference': 'വ്യത്യാസം',
    'stockInventory.notes': 'കുറിപ്പുകൾ',
    'stockInventory.status': 'സ്റ്റാറ്റസ്',
    'stockInventory.noRecords': 'സ്റ്റോക്ക് എണ്ണം ഇതുവരെ രേഖപ്പെടുത്തിയിട്ടില്ല',
    'stockInventory.customer': 'ഉപഭോക്താവ്',
    'stockInventory.itemName': 'ഇനത്തിന്റെ പേര്',
    'stockInventory.quantity': 'അളവ്',
    'stockInventory.unitPrice': 'യൂണിറ്റ് വില',
    'stockInventory.total': 'ആകെ',
    'stockInventory.noSalesData': 'വിൽപ്പന ഡാറ്റയില്ല. ഡാറ്റ എടുക്കാൻ "റിപ്പോർട്ട് ലോഡ് ചെയ്യുക" ക്ലിക്ക് ചെയ്യുക.',
    'stockInventory.totalQtySold': 'മൊത്തം വിറ്റ അളവ്',
    'stockInventory.totalSalesAmount': 'മൊത്തം വിൽപ്പന തുക',
    'stockInventory.recordStockCount': 'സ്റ്റോക്ക് എണ്ണം രേഖപ്പെടുത്തുക',
    'stockInventory.selectItem': 'ഇനം തിരഞ്ഞെടുക്കുക...',
    'stockInventory.actualQuantity': 'യഥാർത്ഥ അളവ്',
    'stockInventory.systemQuantity': 'സിസ്റ്റം അളവ്',
    'stockInventory.reasonNotes': 'വ്യത്യാസത്തിന്റെ കാരണം, പരിശോധിച്ച സ്ഥാനം മുതലായവ...',
  ...
  ur: {
    ...
    'nav.invoices': 'رسیدیں',
    'nav.users': 'صارفین',
    'nav.stockInventory': 'اسٹاک انوینٹری',
    'auth.login': 'لاگ ان',
    'auth.signup': 'سائن اپ',
    'auth.email': 'ای میل',
    ...
    'dashboard.totalBranches': 'کل شاخیں',
    'dashboard.todayAttendance': 'آج کی حاضری',
    'dashboard.activePackages': 'فعال پیکجز',
    'dashboard.expiringPackages': 'جلد ختم ہونے والے',
    'students.title': 'طلباء',
    'students.add': 'طالب علم شامل کریں',
    'students.search': 'طلباء تلاش کریں...',
    'students.name': 'نام',
    'students.phone': 'فون',
    'students.nationality': 'قومیت',
    'students.address': 'پتہ',
    'students.package': 'پیکج',
    'students.branch': 'شاخ',
    'students.status': 'حیثیت',
    'students.active': 'فعال',
    'students.inactive': 'غیر فعال',
    'students.actions': 'اعمال',
    'students.edit': 'ترمیم',
    'students.delete': 'حذف کریں',
    'students.packageStart': 'پیکج شروع',
    'students.packageEnd': 'پیکج ختم',
    'students.notes': 'نوٹس',
    'attendance.title': 'حاضری',
    'attendance.mark': 'حاضری لگائیں',
    'attendance.date': 'تاریخ',
    'attendance.student': 'طالب علم',
    'attendance.status': 'حیثیت',
    'attendance.present': 'حاضر',
    'attendance.absent': 'غیر حاضر',
    'attendance.late': 'دیر سے',
    'attendance.note': 'نوٹ',
    'attendance.markedBy': 'کی طرف سے نشان لگایا',
    'attendance.history': 'حاضری کی تاریخ',
    'packages.title': 'پیکجز',
    'packages.add': 'پیکج شامل کریں',
    'packages.name': 'پیکج کا نام',
    'packages.sessionsPerMonth': 'سیشن/ماہ',
    'packages.sessionsPerWeek': 'سیشن/ہفتہ',
    'packages.price': 'قیمت',
    'packages.description': 'تفصیل',
    'branches.title': 'شاخیں',
    'branches.add': 'شاخ شامل کریں',
    'branches.name': 'شاخ کا نام',
    'branches.location': 'مقام',
    'reports.title': 'رپورٹیں',
    ...
    'settings.academyName': 'اکیڈمی کا نام',
    'settings.logo': 'لوگو',
    'settings.language': 'زبان',
    'settings.notifications': 'اطلاعات',
    'settings.theme': 'تھیم',
    'settings.save': 'محفوظ کریں',
    'settings.taxNumber': 'ٹیکس رجسٹریشن نمبر',
    'role.super_admin': 'سپر ایڈمن',
    'role.branch_manager': 'شاخ مینیجر',
    'role.coach': 'کوچ',
    'role.stock_manager': 'اسٹاک مینیجر',
    'role.accountant': 'اکاؤنٹنٹ',
    'invoices.title': 'رسیدیں',
    'invoices.invoice': 'رسید',
    'invoices.invoiceNumber': 'رسید نمبر',
    'invoices.invoiceDetails': 'رسید کی تفصیلات',
    'invoices.date': 'تاریخ',
    'invoices.customer': 'گاہک',
    'invoices.branch': 'شاخ',
    'invoices.total': 'کل',
    'invoices.paymentMethod': 'ادائیگی کا طریقہ',
    'invoices.paymentStatus': 'ادائیگی کی حیثیت',
    'invoices.status': 'حیثیت',
    'invoices.search': 'رسیدیں تلاش کریں...',
    'invoices.allBranches': 'تمام شاخیں',
    'invoices.allPaymentMethods': 'تمام ادائیگی کے طریقے',
    'invoices.allStatuses': 'تمام حیثیتیں',
    'invoices.dateFrom': 'تاریخ سے',
    'invoices.dateTo': 'تاریخ تک',
    'invoices.totalRevenue': 'کل آمدنی',
    'invoices.totalPaid': 'کل ادا شدہ',
    'invoices.totalPending': 'کل زیر التواء',
    'invoices.noInvoices': 'کوئی رسیدیں نہیں ملیں',
    'invoices.billTo': 'بل دیں',
    'invoices.item': 'آئٹم',
    'invoices.quantity': 'مقدار',
    'invoices.unitPrice': 'یونٹ کی قیمت',
    'invoices.subtotal': 'ذیلی کل',
    'invoices.vat': 'ویٹ',
    'invoices.amountPaid': 'ادا شدہ رقم',
    'invoices.thankYou': 'آپ کے کاروبار کا شکریہ!',
    'sales.cash': 'نقد',
    'sales.card': 'کارڈ',
    'sales.installment': 'قسط',
    'sales.paid': 'ادا شدہ',
    'sales.pending': 'زیر التواء',
    'sales.partial': 'جزوی',
    'stockInventory.title': 'اسٹاک انوینٹری مینجمنٹ',
    'stockInventory.subtitle': 'اسٹاک کی تعداد اور فروخت کی رپورٹس ٹریک کریں',
    'stockInventory.stockCount': 'اسٹاک کی تعداد',
    'stockInventory.salesReport': 'فروخت کی رپورٹ',
    'stockInventory.item': 'آئٹم',
    'stockInventory.allItems': 'تمام آئٹمز',
    'stockInventory.startDate': 'شروع کی تاریخ',
    'stockInventory.endDate': 'اختتامی تاریخ',
    'stockInventory.loadReport': 'رپورٹ لوڈ کریں',
    'stockInventory.newStockCount': 'نئی اسٹاک کی تعداد',
    'stockInventory.exportCSV': 'CSV میں ایکسپورٹ کریں',
    'stockInventory.date': 'تاریخ',
    'stockInventory.systemQty': 'سسٹم کی مقدار',
    'stockInventory.actualQty': 'حقیقی مقدار',
    'stockInventory.difference': 'فرق',
    'stockInventory.notes': 'نوٹس',
    'stockInventory.status': 'حیثیت',
    'stockInventory.noRecords': 'ابھی تک کوئی اسٹاک کی تعداد ریکارڈ نہیں کی گئی',
    'stockInventory.customer': 'گاہک',
    'stockInventory.itemName': 'آئٹم کا نام',
    'stockInventory.quantity': 'مقدار',
    'stockInventory.unitPrice': 'یونٹ کی قیمت',
    'stockInventory.total': 'کل',
    'stockInventory.noSalesData': 'کوئی فروخت کا ڈیٹا نہیں۔ ڈیٹا حاصل کرنے کے لیے "رپورٹ لوڈ کریں" پر کلک کریں۔',
    'stockInventory.totalQtySold': 'کل فروخت شدہ مقدار',
    'stockInventory.totalSalesAmount': 'کل فروخت کی رقم',
    'stockInventory.recordStockCount': 'اسٹاک کی تعداد ریکارڈ کریں',
    'stockInventory.selectItem': 'آئٹم منتخب کریں...',
    'stockInventory.actualQuantity': 'حقیقی مقدار',
    'stockInventory.systemQuantity': 'سسٹم کی مقدار',
    'stockInventory.reasonNotes': 'فرق کی وجہ، چیک کیا گیا مقام، وغیرہ...',
  ...
  fil: {
    ...
    'nav.branches': 'Mga Sangay',
    'nav.reports': 'Mga Ulat',
    'nav.settings': 'Mga Setting',
    'nav.logout': 'Mag-logout',
    'nav.schemes': 'Mga Scheme',
    'nav.stock': 'Stock',
    'nav.sales': 'Mga Benta',
    ...
    'dashboard.totalStudents': 'Kabuuang Estudyante',
    'dashboard.totalBranches': 'Kabuuang Sangay',
    'dashboard.todayAttendance': 'Pagdalo Ngayon',
    'dashboard.activePackages': 'Aktibong Pakete',
    'dashboard.expiringPackages': 'Malapit nang Mag-expire',
    'students.title': 'Mga Estudyante',
    'students.add': 'Magdagdag ng Estudyante',
    'students.search': 'Maghanap ng estudyante...',
    'students.name': 'Pangalan',
    'students.phone': 'Telepono',
    'students.nationality': 'Nasyonalidad',
    'students.address': 'Address',
    'students.package': 'Pakete',
    'students.branch': 'Sangay',
    'students.status': 'Katayuan',
    'students.active': 'Aktibo',
    'students.inactive': 'Hindi Aktibo',
    'students.actions': 'Mga Aksyon',
    'students.edit': 'I-edit',
    'students.delete': 'Tanggalin',
    'students.packageStart': 'Simula ng Pakete',
    'students.packageEnd': 'Katapusan ng Pakete',
    'students.notes': 'Mga Tala',
    'role.super_admin': 'Super Admin',
    'role.branch_manager': 'Branch Manager',
    'role.coach': 'Coach',
    'role.stock_manager': 'Stock Manager',
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (saved && ['en', 'ar', 'hi', 'ml', 'ur', 'fil'].includes(saved)) {
